...
class KegiatanController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('staf/kegiatan/index', [
    ...
    {
        return Inertia::render('staf/kegiatan/form');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return to_route('staf.kegiatan.index')->with('success', 'Kegiatan berhasil dibuat.');
    }
    ...
    public function update(Request $request, Postingan $postingan): RedirectResponse
    {
        ...
        return to_route('staf.kegiatan.index')->with('success', 'Kegiatan berhasil diperbarui.');
    }
    ...
    public function destroy(Postingan $postingan): RedirectResponse
    {
        ...
        return to_route('staf.kegiatan.index')->with('success', "Kegiatan \"{$nama}\" berhasil dihapus.");
    }
