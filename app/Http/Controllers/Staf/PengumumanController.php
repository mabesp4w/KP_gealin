...
class PengumumanController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('staf/pengumuman/index', [
    ...
    {
        return Inertia::render('staf/pengumuman/form');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return to_route('staf.pengumuman.index')->with('success', 'Pengumuman berhasil dibuat.');
    }
    ...
    public function update(Request $request, Postingan $postingan): RedirectResponse
    {
        ...
        return to_route('staf.pengumuman.index')->with('success', 'Pengumuman berhasil diperbarui.');
    }
    ...
    public function destroy(Postingan $postingan): RedirectResponse
    {
        ...
        return to_route('staf.pengumuman.index')->with('success', "Pengumuman \"{$nama}\" berhasil dihapus.");
    }
