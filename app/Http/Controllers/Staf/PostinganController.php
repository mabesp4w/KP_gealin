...
class PostinganController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('staf/postingan/index', [
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return to_route('staf.postingan.index')->with('success', 'Postingan berhasil dibuat.');
    }
    ...
    public function update(Request $request, Postingan $postingan): RedirectResponse
    {
        ...
        return to_route('staf.postingan.index')->with('success', 'Postingan berhasil diperbarui.');
    }
    ...
    public function destroy(Postingan $postingan): RedirectResponse
    {
        ...
        return to_route('staf.postingan.index')->with('success', "Postingan \"{$nama}\" berhasil dihapus.");
    }
    ...
    {
        return [
            'kategori' => ['required', 'in:berita,kegiatan,pengumuman,berita_video,artikel'],
