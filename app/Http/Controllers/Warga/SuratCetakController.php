...
{
    public function cetak(Request $request, string $pengajuanId)
    {
        $user = $request->user();

        // Cari pengajuan milik user yang sudah selesai
        $pengajuan = PengajuanSurat::where('id', $pengajuanId)
            ->where('user_id', $user->id)
            ->where('status', 'selesai')
            ->firstOrFail();

        // Cari surat yang terkait dengan pengajuan
        $surat = Surat::where('pengajuan_surat_id', $pengajuan->id)
    ...
    public function preview(Request $request, string $pengajuanId)
    {
        $user = $request->user();
