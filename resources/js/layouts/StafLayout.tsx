...
const menuItems = [
    ...
    { type: 'title' as const, label: 'Pengaturan' },
    {
        label: 'Data Kelurahan',
        href: '/staf/settings/kelurahan',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <Navbar className="sticky top-0 z-30 border-b border-base-300 bg-base-100 shadow-sm">
                        ...
                        <NavbarEnd>
                            <div className="flex items-center gap-3">
                                <a href="/" target="_blank" rel="noopener noreferrer" className="btn btn-ghost btn-sm gap-2 hidden sm:inline-flex">
