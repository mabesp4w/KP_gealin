...
export const pengumumanSchema = yup.object({
    ...
    isi: yup.string().required('Isi pengumuman wajib diisi'),
    is_published: yup.boolean().nullable().transform((v) => v ?? false),
});

export type PengumumanFormValues = yup.InferType<typeof pengumumanSchema>;

export const defaultValues: PengumumanFormValues = {
    judul: '',
    slug: null,
    ringkasan: null,
    isi: '',
